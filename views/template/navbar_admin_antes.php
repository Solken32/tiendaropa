...
<body>
  <main class="container-fluid pb-3 pb-sm-4">
    ...
    <!-- Main content-->
    <section class="float-right col-12 col-md-10 col-lg-12 col-xl-10">
      <div class="col-xl-12">

        

        <aside class="cs-offcanvas cs-offcanvas-expand bg-dark show" id="componentsNav">
          <div class="cs-offcanvas-cap d-none d-lg-block py-4">
            <a class="navbar-brand py-2" href="./index.php">
              <img src="../../assets_tienda/img/nav.png" alt="Logo" width="130">
            </a>
          </div>
          ...
          <div class="cs-offcanvas-body px-0 pt-4 pb-grid-gutter" data-simplebar data-simplebar-inverse>
            ...
            <nav class="nav nav-light">
              ...
              <a class="nav-link px-4 <?php echo basename($current_url) === 'cuenta.php' ? 'active' : ''; ?>" href="./cuentaconf.php">Cuenta</a>
              ...
              <a class="nav-link px-4 <?php echo basename($current_url) === 'register.php' ? 'active' : ''; ?>" href="./register.php">Registrar</a>
          ...
          <div style="position: fixed; z-index: 999; bottom: 20px; right: 20px; background-color: #fff; padding: 5px; border-radius: 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.2);">
            ...
            $fechaHoraActual = date('d') . ' ' . date('F') . ' ' . date('Y');
