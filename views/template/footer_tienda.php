    ...
    <div class="row pb-sm-2">
      <div class="col-6 col-sm-3 col-lg-2 mb-4">
        ...
        <ul class="nav nav-light flex-column">
          <li class="nav-item mb-2">
            <a href="<?php echo VIEWSTIENDA_PATH; ?>entregaDevolu.php" class="nav-link mr-lg-0 mr-sm-4 p-0 font-weight-normal">Entrega y devoluciones</a>
          </li>
          <li class="nav-item mb-2">
            <a href="<?php echo VIEWSTIENDA_PATH; ?>preguntasFrecuen.php" class="nav-link mr-lg-0 mr-sm-4 p-0 font-weight-normal">Preguntas frecuentes</a>
          </li>
          <li class="nav-item mb-2">
            <a href="<?php echo VIEWSTIENDA_PATH; ?>politicaPrivacidad.php" class="nav-link mr-lg-0 mr-sm-4 p-0 font-weight-normal">Politica de Privacidad</a>
          </li>
          <li class="nav-item mb-2">
            <a href="<?php echo VIEWSTIENDA_PATH; ?>blog.php" class="nav-link mr-lg-0 mr-sm-4 p-0 font-weight-normal">Blog</a>
          </li>
          <li class="nav-item mb-2">
            <a href="<?php echo VIEWSTIENDA_PATH; ?>contacto.php" class="nav-link mr-lg-0 mr-sm-4 p-0 font-weight-normal">Contactos</a>
          </li>
        </ul>
      </div>
      ...
      <div class="col-lg-4 col-xl-3 mb-4">
        ...
        <div class="d-flex flex-wrap flex-sm-nowrap">
          <iframe src="<?php echo $gmap; ?>" width="100%" height="200px" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
      </div>
...
<script src="../../assets_tienda/js/smooth-scroll.polyfills.min.js"></script>
<script src="../../assets_tienda/js/nouislider.min.js"></script>
...
<script src="../../assets_tienda/vendor/tiny-slider/dist/min/tiny-slider.js"></script>
...
<!-- <?php
      if (basename($_SERVER['PHP_SELF']) === '../tienda/catalogo.php') {
      ?>
<script>
...
<?php if (isset($success)) : ?>
  <script src="../../assets_tienda/js/iziToast.min.js"></script>
  <link rel="stylesheet" href="../../assets_tienda/css/iziToast.min.css">
  <script>
...
<!-- Main theme script-->
<script src="../../assets_tienda/js/cleave.min.js"></script>
<script src="../../assets_tienda/js/theme.min.js"></script>
<script src="../../assets_tienda/js/simplebar.min.js"></script>
<script src="../../assets_tienda/js/java.js"></script>
