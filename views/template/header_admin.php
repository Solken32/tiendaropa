...
<body>
  <main>
    <!-- Main content-->
    <section class="col-12 col-md-10 col-lg-12 col-xl-9">
      <div class="col-xl-9">
          ...
          <ul class="navbar-nav ml-auto d-none d-lg-flex align-items-center">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                <a class="dropdown-item <?php echo strpos($current_url, 'cuenta.php') !== false ? 'active' : ''; ?>" href="./cuentaconf.php">Perfil</a>
