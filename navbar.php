...
$icon = "../assetss/img/favicon.png";
$logo = "../assetss/img/logo.png";
$logonav = "../assetss/img/nav.png";
...
<head>
  ...
  <!-- Vendor Styles-->
  <link rel="stylesheet" media="screen" href="assetss/vendor/tiny-slider/dist/tiny-slider.css" />

  <!-- Style-->
  <link rel="stylesheet" media="screen" href="assetss/css/demo/ecommerce/style.css" />
  <link rel="stylesheet" media="screen" href="assetss/css/demo/ecommerce/nouislider.min.css">
  <link rel="stylesheet" media="screen" href="assetss/css/demo/ecommerce/simplebar.min.css">

  

  <!-- Main Theme Styles + Bootstrap-->
  <link rel="stylesheet" media="screen" href="assetss/css/demo/ecommerce/theme.min.css">
...
<body>
  ...
  <div class="whatsapp-icon">
    <a href="https://api.whatsapp.com/send?phone=51<?php echo $whatsapp; ?>" target="_blank">
      <img src="./assetss/img/icon_whast_vf.png" alt="WhatsApp Icon">
        ...
        <div class="container d-flex align-items-center px-0 px-xl-3">
          ...
          <div>
            <a href="#" class="topbar-link" id="penLink" onclick="window.location.href = window.location.href; changeCurrency()">
              <img src="./assetss/img/ecommerce/flags/pe.png" class="mr-2" width="20" alt="Perú">
              PEN - S/.
            </a>
            <div class="dropdown-menu dropdown-menu-right">
              <a class="dropdown-item">
                <img src="./assetss/img/ecommerce/flags/en.png" class="mr-2" width="20" alt="E.E.U.U">
                USD - $
              </a>
            </div>
          </div>
      ...
      <div class="navbar navbar-expand-lg navbar-light bg-light navbar-sticky" data-fixed-element>
        <div class="container px-0 px-xl-3">
          <a href="./" class="navbar-brand order-lg-1 mr-0 pr-lg-3 mr-lg-4">
            <img src="assetss/img/nav.png" alt="Nav Logo" width="130">
          </a>
          <!-- Toolbar -->
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-3 d-none d-lg-block py-2">
                        <a href="#" class="d-block text-decoration-none pt-1">
                          <img src="./assetss/img/ecommerce/megamenu.jpg" class="d-block rounded mb-3" alt="Promo banner">
